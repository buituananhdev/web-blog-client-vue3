            ...
            <div class="grid gap-8 lg:grid-cols-2">
                ...
                >
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        ...
                        <span class="text-sm">{{ getPostTime(post.timestamp) }}</span>
                    </div>
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-4">
                            ...
                            />
                            <span class="font-medium dark:text-white"> {{ post.owner.fullname }} </span>
                        </div>
                        <a
                            href="#"
...
import RRuleBuilder from '@/components/RRuleBuilder.vue';
const posts = ref([])
onMounted(async () => {
    try {
